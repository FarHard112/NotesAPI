...
export class Client extends ClientBase {
    ...
    protected processGetAll(response: Response): Promise<NoteListVm> {
        ...
        if (status === 200) {
            ...
            result200 = _responseText === "" ? null : <NoteListVm>JSON.parse(_responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
    ...
    protected processCreate(response: Response): Promise<string> {
        ...
        if (status === 201) {
            ...
            result201 = _responseText === "" ? null : <string>JSON.parse(_responseText, this.jsonParseReviver);
            return result201;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
